        ...
        {sections.map((section, idx) => (
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px", paddingBottom: "16px", borderBottom: "1px solid #e2e8f0" }}>
              <div style={{ width: "40px", height: "40px", background: "#f1f5f9", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", color: "#22c55e" }}>
                {section.icon}
              </div>
              <div>
                ...
                <div key={field.key}>
                  ...
                  {field.type === "toggle" ? (
                    <button
                      ...
                      style={{
                        padding: "8px 16px",
                        background: settings[field.key as keyof typeof settings] ? "#22c55e" : "#e2e8f0",
